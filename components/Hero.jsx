...
export default function Hero() {
  ...
  return (
    <section className="hero-section h-[60vh] md:h-[70vh]" ref={ref}>
      <div className="absolute top-1/4 left-0 right-12 bottom-0 z-20 p-5 h-full">
        <h1 className="text-snow text-3xl">
          <span className="text-secondaryColor">StepStyle:</span> Your Ultimate Destination for Sneakerheads
        </h1>
