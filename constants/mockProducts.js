export const newArrivals = [
  {
    ...
    photos: [
      ...
      "sneakers/nikes/SB DUNK LOW PRO 'IOWA'3.jpg",
      "sneakers/nikes/SB DUNK LOW PRO 'IOWA'4.jpg",
    ],
  ...
  {
    id: 2,
    name: "SWAROVSKI X WMNS AIR MAX 97 LX 'SILVER BULLET'",
    brand: "New Balance",
    price: 80,
    originalPrice: 80,
    percent: 1,
  ...
  {
    id: 3,
    name: "AIR JORDAN 4 RETRO 'FEAR' 2013",
    brand: "Nike",
    price: 537,
    originalPrice: 537,
    percent: 38,
    ...
    description:
      "The Air Jordan 4 'Fear' features a black, Pure Platinum, and Cool Grey upper with white accents. A black speckled midsole, blue Nike Air unit and a white outsole are also included in the design. The sneaker dropped next to a Jordan 3 and Jordan 5 colorways in August 2013.",
    sku: "SKU: 626969 030",
  ...
  {
    id: 4,
    name: "Donk Low Sp Retro 'Veneer 2024'",
    brand: "Nike",
    price: 100,
    originalPrice: 100,
    percent: 18,
    ...
    description:
      "The 2024 version of the Nike Dunk Low SP Retro 'Veneer' brings back a sought-after edition of the CO.JP 'Ugly Duckling Pack' from 2001. These shoes rock a brown suede upper with contrasting green overlays and a purple Swoosh. The collar lining and insoles are doused in lime green for a colorful pop. The Nike logo lands on the tongue tag and back tab for a signature look. These shoes keep the traditional rubber cupsole, coupled with white sidewalls with a violet rubber outsole.",
    sku: "DA1469 200 24",
  ...
  },
  {
    ...
    description:
      "Bringing back a classic OG colorway, the 2024 version of the Jordan 4 Retro 'Military Blue' also known as 'Industrial Blue' returns with an off-white leather upper and nubuck forefoot overlays. The blue Jumpman logo decorates the tongue tag, matching the color of the molded eyelets, back tab and the underneath of the side panel netting. These shoes have a lightweight midsole with an encapsulated Air-sole forefoot unit and a visible Air bag in the heel.",
    sku: "FV5029 141",
  ...
  {
    id: 6,
    name: "Jordan Jumpman Jack TR 'Sail'",
    brand: "Nike",
    price: 354,
    originalPrice: 354,
    percent: 1,
    ...
    description:
      "A neutral take on Travis Scott's debut signature shoes, the Jordan Jumpman Jack TR 'Sail' have a dark brown canvas upper with off-white leather overlays and a beige backward Swoosh. Thesesneakers have an adjustable midfoot strap, paired with regular shoelaces and contrasting red accents on the Jumpman tongue logo. Scott's Cactus Jack face logo is embossed on the back heel, while a white foam midsole and a gum rubber outsole complete the look.",
    sku: "FZ8117 100",
  ...
  },
  {
    ...
    description:
      "Utilizing a sleek monochrome finish, the adidas Yeezy Foam Runner ‘Onyx’ is an understated colorway for a futuristic slip-on. A molded one-piece upper showcases open vents for breathability, while the injected EVA foam is lightweight and is secured by a unique traction pattern for grip.",
    sku: "HP8739",
    ...
    photos: [
      ...
      "sneakers/adidas/YEEZY FOAM RUNNER 'ONYX' 2.jpg",
      "sneakers/adidas/YEEZY FOAM RUNNER 'ONYX' 3.jpg",
    ],
    isOffer: true,
  },
  {
    id: 8,
    name: "Gell 1130 'Black Pure Silver'",
    brand: "Asics",
    price: 133,
    originalPrice: 133,
    percent: 1,
    ...
    photos: [
      ...
      "sneakers/asics/GEL 1130 'BLACK PURE SILVER' 2.jpg",
      "sneakers/asics/GEL 1130 'BLACK PURE SILVER' 3.jpg",
    ],
    isOffer: false,
  },
];
